        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group row">
                <label for="titulo" class="col-sm-3 col-form-label">Pregunta</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="titulo" placeholder="Pregunta" autocomplete="off" autofocus>
                </div>
              </div>
              <div class="form-group row">
