        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group row">
                ...
                <label for="puntaje" class="col-sm-3 col-form-label">Puntaje</label>
                  <div class="col-sm-9">
                  <input type="text" class="form-control" id="puntaje" placeholder="puntaje" autocomplete="off" autofocus>
                </div>
              </div>         
            </div>
